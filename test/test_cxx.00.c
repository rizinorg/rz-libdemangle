...
mu_demangle_tests(gpl,
	...
	mu_demangle_test("_Z10initThemesv_ptr", "initThemes(void)"),
	mu_demangle_test("_Z11InitUIViewsv_ptr", "InitUIViews(void)"),
	mu_demangle_test("_Z13getThemeColor12BNThemeColor_ptr", "getThemeColor(BNThemeColor)"),
	mu_demangle_test("_Z13InitUIActionsv_ptr", "InitUIActions(void)"),
	mu_demangle_test("_Z13InitUIPluginsv_ptr", "InitUIPlugins(void)"),
	mu_demangle_test("_Z14getActiveThemev_ptr", "getActiveTheme(void)"),
	mu_demangle_test("_Z14setActiveThemeRK7QStringb_ptr", "setActiveTheme(QString const&, bool)"),
	mu_demangle_test("_Z15resetUserThemesv_ptr", "resetUserThemes(void)"),
	...
	mu_demangle_test("_Z19getExtraFontSpacingv_ptr", "getExtraFontSpacing(void)"),
	...
	mu_demangle_test("_Z23getDefaultMonospaceFontv_ptr", "getDefaultMonospaceFont(void)"),
	...
	mu_demangle_test("_Z26getDefaultExtraFontSpacingv_ptr", "getDefaultExtraFontSpacing(void)"),
	...
	mu_demangle_test("_ZN10QEventLoopD1Ev_ptr", "QEventLoop::~QEventLoop(void)"),
	mu_demangle_test("_ZN10QJsonValueD1Ev_ptr", "QJsonValue::~QJsonValue(void)"),
	mu_demangle_test("_ZN10QStatusBar11showMessageERK7QStringi_ptr", "QStatusBar::showMessage(QString const&, int)"),
	mu_demangle_test("_ZN10QStatusBar12clearMessageEv_ptr", "QStatusBar::clearMessage(void)"),
	...
	mu_demangle_test("_ZN10QTableView23resizeColumnsToContentsEv_ptr", "QTableView::resizeColumnsToContents(void)"),
	...
	mu_demangle_test("_ZN10QTableViewD2Ev_ptr", "QTableView::~QTableView(void)"),
	...
	mu_demangle_test("_ZN10QTabWidgetD2Ev_ptr", "QTabWidget::~QTabWidget(void)"),
	mu_demangle_test("_ZN11DockHandler10setVisibleERK7QStringb_ptr", "DockHandler::setVisible(QString const&, bool)"),
	mu_demangle_test("_ZN11DockHandler11updateFontsEv_ptr", "DockHandler::updateFonts(void)"),
	mu_demangle_test("_ZN11DockHandler11updateThemeEv_ptr", "DockHandler::updateTheme(void)"),
	...
	mu_demangle_test("_ZN11DockHandler15addActionOnShowERK7QStringRKSt8functionIFvvEE_ptr", "DockHandler::addActionOnShow(QString const&, std::function<void (void)> const&)"),
	mu_demangle_test("_ZN11DockHandler17shouldResizeDocksEv_ptr", "DockHandler::shouldResizeDocks(void)"),
	...
	mu_demangle_test("_ZN11DockHandler23notifyRestoredFromStateEv_ptr", "DockHandler::notifyRestoredFromState(void)"),
	mu_demangle_test("_ZN11DockHandler5closeEv_ptr", "DockHandler::close(void)"),
	...
	mu_demangle_test("_ZN11FileContext10isModifiedEv_ptr", "FileContext::isModified(void)"),
	mu_demangle_test("_ZN11FileContext11getBestTypeEv_ptr", "FileContext::getBestType(void)"),
	...
	mu_demangle_test("_ZN11FileContext17closeAllOpenFilesEv_ptr", "FileContext::closeAllOpenFiles(void)"),
	mu_demangle_test("_ZN11FileContext17getAvailableTypesEv_ptr", "FileContext::getAvailableTypes(void)"),
	mu_demangle_test("_ZN11FileContext17registerReferenceEP7QWidget_ptr", "FileContext::registerReference(QWidget*)"),
	mu_demangle_test("_ZN11FileContext19getOpenFileContextsEv_ptr", "FileContext::getOpenFileContexts(void)"),
	mu_demangle_test("_ZN11FileContext19setCurrentViewFrameEP9ViewFrame_ptr", "FileContext::setCurrentViewFrame(ViewFrame*)"),
	mu_demangle_test("_ZN11FileContext20refreshDataViewCacheEv_ptr", "FileContext::refreshDataViewCache(void)"),
	mu_demangle_test("_ZN11FileContext7newFileEv_ptr", "FileContext::newFile(void)"),
	...
	mu_demangle_test("_ZN11QFileDevice5closeEv_ptr", "QFileDevice::close(void)"),
	...
	mu_demangle_test("_ZN11QGridLayoutC1Ev_ptr", "QGridLayout::QGridLayout(void)"),
	mu_demangle_test("_ZN11QHBoxLayoutC1EP7QWidget_ptr", "QHBoxLayout::QHBoxLayout(QWidget*)"),
	mu_demangle_test("_ZN11QHBoxLayoutC1Ev_ptr", "QHBoxLayout::QHBoxLayout(void)"),
	...
	mu_demangle_test("_ZN11QJsonObjectD1Ev_ptr", "QJsonObject::~QJsonObject(void)"),
	...
	mu_demangle_test("_ZN11QMainWindowD2Ev_ptr", "QMainWindow::~QMainWindow(void)"),
	...
	mu_demangle_test("_ZN11QMessageBoxD1Ev_ptr", "QMessageBox::~QMessageBox(void)"),
	mu_demangle_test("_ZN11QMetaObject10ConnectionD1Ev_ptr", "QMetaObject::Connection::~Connection(void)"),
	...
	mu_demangle_test("_ZN11QScrollAreaD2Ev_ptr", "QScrollArea::~QScrollArea(void)"),
	mu_demangle_test("_ZN11QTextStream7readAllEv_ptr", "QTextStream::readAll(void)"),
	...
	mu_demangle_test("_ZN11QTextStreamD1Ev_ptr", "QTextStream::~QTextStream(void)"),
	...
	mu_demangle_test("_ZN11QVBoxLayoutC1Ev_ptr", "QVBoxLayout::QVBoxLayout(void)"),
	...
	mu_demangle_test("_ZN12QApplication11focusWidgetEv_ptr", "QApplication::focusWidget(void)"),
	...
	mu_demangle_test("_ZN12QApplication12activeWindowEv_ptr", "QApplication::activeWindow(void)"),
	mu_demangle_test("_ZN12QApplication17activeModalWidgetEv_ptr", "QApplication::activeModalWidget(void)"),
	mu_demangle_test("_ZN12QApplication4execEv_ptr", "QApplication::exec(void)"),
	mu_demangle_test("_ZN12QApplication4fontEv_ptr", "QApplication::font(void)"),
	...
	mu_demangle_test("_ZN12QApplicationD2Ev_ptr", "QApplication::~QApplication(void)"),
	mu_demangle_test("_ZN12QDirIterator4nextEv_ptr", "QDirIterator::next(void)"),
	...
	mu_demangle_test("_ZN12QDirIteratorD1Ev_ptr", "QDirIterator::~QDirIterator(void)"),
	mu_demangle_test("_ZN12QEasingCurveC1ENS_4TypeE_ptr", "QEasingCurve::QEasingCurve(QEasingCurve::Type)"),
	mu_demangle_test("_ZN12QEasingCurveD1Ev_ptr", "QEasingCurve::~QEasingCurve(void)"),
	mu_demangle_test("_ZN12QFontMetricsC1ERK5QFont_ptr", "QFontMetrics::QFontMetrics(QFont const&)"),
	mu_demangle_test("_ZN12QFontMetricsD1Ev_ptr", "QFontMetrics::~QFontMetrics(void)"),
	...
	mu_demangle_test("_ZN12QInputDialogD1Ev_ptr", "QInputDialog::~QInputDialog(void)"),
	...
	mu_demangle_test("_ZN12QKeySequenceC1Ev_ptr", "QKeySequence::QKeySequence(void)"),
	mu_demangle_test("_ZN12QKeySequenceD1Ev_ptr", "QKeySequence::~QKeySequence(void)"),
	...
	mu_demangle_test("_ZN12QStyleOptionD1Ev_ptr", "QStyleOption::~QStyleOption(void)"),
	...
	mu_demangle_test("_ZN13QFileAccessor5CloseEv_ptr", "QFileAccessor::Close(void)"),
	mu_demangle_test("_ZN13QFileAccessorC1ERK7QStringb_ptr", "QFileAccessor::QFileAccessor(QString const&, bool)"),
	mu_demangle_test("_ZN13QFileAccessorD1Ev_ptr", "QFileAccessor::~QFileAccessor(void)"),
	...
	mu_demangle_test("_ZN13QFontMetricsFD1Ev_ptr", "QFontMetricsF::~QFontMetricsF(void)"),
	...
	mu_demangle_test("_ZN13QItemDelegateD2Ev_ptr", "QItemDelegate::~QItemDelegate(void)"),
	...
	mu_demangle_test("_ZN13QJsonDocumentD1Ev_ptr", "QJsonDocument::~QJsonDocument(void)"),
	...
	mu_demangle_test("_ZN14ClickableLabel7clickedEv_ptr", "ClickableLabel::clicked(void)"),
	mu_demangle_test("_ZN14CommandPalette10focusInputEv_ptr", "CommandPalette::focusInput(void)"),
	...
	mu_demangle_test("_ZN14QWebEnginePage7scriptsEv_ptr", "QWebEnginePage::scripts(void)"),
	mu_demangle_test("_ZN14QWebEnginePageC2EP7QObject_ptr", "QWebEnginePage::QWebEnginePage(QObject*)"),
	mu_demangle_test("_ZN14QWebEnginePageD2Ev_ptr", "QWebEnginePage::~QWebEnginePage(void)"),
	...
	mu_demangle_test("_ZN15QGuiApplication22queryKeyboardModifiersEv_ptr", "QGuiApplication::queryKeyboardModifiers(void)"),
	mu_demangle_test("_ZN15QGuiApplication7screensEv_ptr", "QGuiApplication::screens(void)"),
	mu_demangle_test("_ZN15QGuiApplication9clipboardEv_ptr", "QGuiApplication::clipboard(void)"),
	...
	mu_demangle_test("_ZN15QNetworkRequestD1Ev_ptr", "QNetworkRequest::~QNetworkRequest(void)"),
	...
	mu_demangle_test("_ZN15QProgressDialog6cancelEv_ptr", "QProgressDialog::cancel(void)"),
	...
	mu_demangle_test("_ZN15QProgressDialogD1Ev_ptr", "QProgressDialog::~QProgressDialog(void)"),
	...
	mu_demangle_test("_ZN15UIActionContextC1Ev_ptr", "UIActionContext::UIActionContext(void)"),
	...
	mu_demangle_test("_ZN15UIActionHandler10setCheckedERK7QStringRKSt8functionIFbvEE_ptr", "UIActionHandler::setChecked(QString const&, std::function<bool (void)> const&)"),
	...
	mu_demangle_test("_ZN15UIActionHandler20setActionDisplayNameERK7QStringRKSt8functionIFS0_vEE_ptr", "UIActionHandler::setActionDisplayName(QString const&, std::function<QString (void)> const&)"),
	...
	mu_demangle_test("_ZN15UIActionHandler24bindPluginCommandActionsEv_ptr", "UIActionHandler::bindPluginCommandActions(void)"),
	mu_demangle_test("_ZN15UIActionHandlerC1Eb_ptr", "UIActionHandler::UIActionHandler(bool)"),
	mu_demangle_test("_ZN15UIActionHandlerD1Ev_ptr", "UIActionHandler::~UIActionHandler(void)"),
	...
	mu_demangle_test("_ZN16MainMenuInstanceD1Ev_ptr", "MainMenuInstance::~MainMenuInstance(void)"),
	...
	mu_demangle_test("_ZN16QCoreApplication18applicationDirPathEv_ptr", "QCoreApplication::applicationDirPath(void)"),
	...
	mu_demangle_test("_ZN16QCoreApplication9argumentsEv_ptr", "QCoreApplication::arguments(void)"),
	...
	mu_demangle_test("_ZN16QWebEngineScriptC1Ev_ptr", "QWebEngineScript::QWebEngineScript(void)"),
	mu_demangle_test("_ZN16QWebEngineScriptD1Ev_ptr", "QWebEngineScript::~QWebEngineScript(void)"),
	...
	mu_demangle_test("_ZN16UIContextHandlerD2Ev_ptr", "UIContextHandler::~UIContextHandler(void)"),
	mu_demangle_test("_ZN17QAbstractItemView11resizeEventEP12QResizeEvent_ptr", "QAbstractItemView::resizeEvent(QResizeEvent*)"),
	mu_demangle_test("_ZN17QAbstractItemView11scrollToTopEv_ptr", "QAbstractItemView::scrollToTop(void)"),
	mu_demangle_test("_ZN17QAbstractItemView13keyPressEventEP9QKeyEvent_ptr", "QAbstractItemView::keyPressEvent(QKeyEvent*)"),
	mu_demangle_test("_ZN17QAbstractItemView14clearSelectionEv_ptr", "QAbstractItemView::clearSelection(void)"),
	...
	mu_demangle_test("_ZN18ContextMenuManager6createEv_ptr", "ContextMenuManager::create(void)"),
	mu_demangle_test("_ZN18ContextMenuManagerC1EP7QWidget_ptr", "ContextMenuManager::ContextMenuManager(QWidget*)"),
	mu_demangle_test("_ZN18ContextMenuManagerD1Ev_ptr", "ContextMenuManager::~ContextMenuManager(void)"),
	...
	mu_demangle_test("_ZN18QAbstractAnimation4stopEv_ptr", "QAbstractAnimation::stop(void)"),
	...
	mu_demangle_test("_ZN18QAbstractItemModel13endResetModelEv_ptr", "QAbstractItemModel::endResetModel(void)"),
	...
	mu_demangle_test("_ZN18QAbstractItemModel15beginResetModelEv_ptr", "QAbstractItemModel::beginResetModel(void)"),
	...
	mu_demangle_test("_ZN18QAbstractItemModelD2Ev_ptr", "QAbstractItemModel::~QAbstractItemModel(void)"),
	...
	mu_demangle_test("_ZN18QAbstractListModelD2Ev_ptr", "QAbstractListModel::~QAbstractListModel(void)"),
	...
	mu_demangle_test("_ZN18QCommandLineOptionD1Ev_ptr", "QCommandLineOption::~QCommandLineOption(void)"),
	mu_demangle_test("_ZN18QCommandLineParser13addHelpOptionEv_ptr", "QCommandLineParser::addHelpOption(void)"),
	mu_demangle_test("_ZN18QCommandLineParser16addVersionOptionEv_ptr", "QCommandLineParser::addVersionOption(void)"),
	...
	mu_demangle_test("_ZN18QCommandLineParserC1Ev_ptr", "QCommandLineParser::QCommandLineParser(void)"),
	mu_demangle_test("_ZN18QCommandLineParserD1Ev_ptr", "QCommandLineParser::~QCommandLineParser(void)"),
	mu_demangle_test("_ZN18QProgressIndicator14startAnimationEv_ptr", "QProgressIndicator::startAnimation(void)"),
	...
	mu_demangle_test("_ZN18QRegularExpressionC1Ev_ptr", "QRegularExpression::QRegularExpression(void)"),
	mu_demangle_test("_ZN18QRegularExpressionD1Ev_ptr", "QRegularExpression::~QRegularExpression(void)"),
	...
	mu_demangle_test("_ZN19HighlightTokenStateC1Ev_ptr", "HighlightTokenState::HighlightTokenState(void)"),
	...
	mu_demangle_test("_ZN19QAbstractTableModelD2Ev_ptr", "QAbstractTableModel::~QAbstractTableModel(void)"),
	...
	mu_demangle_test("_ZN19QStyledItemDelegateD2Ev_ptr", "QStyledItemDelegate::~QStyledItemDelegate(void)"),
	...
	mu_demangle_test("_ZN21QNetworkAccessManagerD1Ev_ptr", "QNetworkAccessManager::~QNetworkAccessManager(void)"),
	...
	mu_demangle_test("_ZN21QPersistentModelIndexD1Ev_ptr", "QPersistentModelIndex::~QPersistentModelIndex(void)"),
	mu_demangle_test("_ZN21QSortFilterProxyModel10invalidateEv_ptr", "QSortFilterProxyModel::invalidate(void)"),
	...
	mu_demangle_test("_ZN21QSortFilterProxyModel16invalidateFilterEv_ptr", "QSortFilterProxyModel::invalidateFilter(void)"),
	...
	mu_demangle_test("_ZN21QSortFilterProxyModelD2Ev_ptr", "QSortFilterProxyModel::~QSortFilterProxyModel(void)"),
	...
	mu_demangle_test("_ZN23QRegularExpressionMatchC1Ev_ptr", "QRegularExpressionMatch::QRegularExpressionMatch(void)"),
	mu_demangle_test("_ZN23QRegularExpressionMatchD1Ev_ptr", "QRegularExpressionMatch::~QRegularExpressionMatch(void)"),
	...
	mu_demangle_test("_ZN4MenuC1Ev_ptr", "Menu::Menu(void)"),
	mu_demangle_test("_ZN4QDirC1ERK7QString_ptr", "QDir::QDir(QString const&)"),
	mu_demangle_test("_ZN4QDirD1Ev_ptr", "QDir::~QDir(void)"),
	...
	mu_demangle_test("_ZN4QPenD1Ev_ptr", "QPen::~QPen(void)"),
	...
	mu_demangle_test("_ZN4QUrlD1Ev_ptr", "QUrl::~QUrl(void)"),
	mu_demangle_test("_ZN4View17getViewFromWidgetEP7QWidget_ptr", "View::getViewFromWidget(QWidget*)"),
	mu_demangle_test("_ZN4View22getDisassemblySettingsEv_ptr", "View::getDisassemblySettings(void)"),
	...
	mu_demangle_test("_ZN5QFileD1Ev_ptr", "QFile::~QFile(void)"),
	...
	mu_demangle_test("_ZN5QFontC1Ev_ptr", "QFont::QFont(void)"),
	mu_demangle_test("_ZN5QFontD1Ev_ptr", "QFont::~QFont(void)"),
	mu_demangle_test("_ZN5QIconC1ERK7QString_ptr", "QIcon::QIcon(QString const&)"),
	mu_demangle_test("_ZN5QIconC1Ev_ptr", "QIcon::QIcon(void)"),
	mu_demangle_test("_ZN5QIconD1Ev_ptr", "QIcon::~QIcon(void)"),
	mu_demangle_test("_ZN5QListIP13QOpenGLShaderED2Ev_47_0", "QList<QOpenGLShader*>::~QList(void)"),
	mu_demangle_test("_ZN5QMenu12addSeparatorEv_ptr", "QMenu::addSeparator(void)"),
	...
	mu_demangle_test("_ZN6QBrushD1Ev_ptr", "QBrush::~QBrush(void)"),
	...
	mu_demangle_test("_ZN6QEventD2Ev_ptr", "QEvent::~QEvent(void)"),
	...
	mu_demangle_test("_ZN6QFrameD2Ev_ptr", "QFrame::~QFrame(void)"),
	...
	mu_demangle_test("_ZN6QLabelD2Ev_ptr", "QLabel::~QLabel(void)"),
	...
	mu_demangle_test("_ZN6QTimer4stopEv_ptr", "QTimer::stop(void)"),
	mu_demangle_test("_ZN6QTimer5startEi_ptr", "QTimer::start(int)"),
	mu_demangle_test("_ZN6QTimer5startEv_ptr", "QTimer::start(void)"),
	...
	mu_demangle_test("_ZN7QCursor3posEv_ptr", "QCursor::pos(void)"),
	...
	mu_demangle_test("_ZN7QDialog4execEv_ptr", "QDialog::exec(void)"),
	mu_demangle_test("_ZN7QDialog6acceptEv_ptr", "QDialog::accept(void)"),
	...
	mu_demangle_test("_ZN7QDialogD2Ev_ptr", "QDialog::~QDialog(void)"),
	...
	mu_demangle_test("_ZN7QLocale6systemEv_ptr", "QLocale::system(void)"),
	mu_demangle_test("_ZN7QLocaleC1Ev_ptr", "QLocale::QLocale(void)"),
	mu_demangle_test("_ZN7QLocaleD1Ev_ptr", "QLocale::~QLocale(void)"),
	...
	mu_demangle_test("_ZN7QObject11deleteLaterEv_ptr", "QObject::deleteLater(void)"),
	...
	mu_demangle_test("_ZN7QObjectD2Ev_ptr", "QObject::~QObject(void)"),
	...
	mu_demangle_test("_ZN7QPixmapD1Ev_ptr", "QPixmap::~QPixmap(void)"),
	...
	mu_demangle_test("_ZN7QRegExpD1Ev_ptr", "QRegExp::~QRegExp(void)"),
	...
	mu_demangle_test("_ZN7QTabBarD2Ev_ptr", "QTabBar::~QTabBar(void)"),
	...
	mu_demangle_test("_ZN7QThread13currentThreadEv_ptr", "QThread::currentThread(void)"),
	mu_demangle_test("_ZN7QThread19requestInterruptionEv_ptr", "QThread::requestInterruption(void)"),
	...
	mu_demangle_test("_ZN7QThreadD2Ev_ptr", "QThread::~QThread(void)"),
	mu_demangle_test("_ZN7QWidget10clearFocusEv_ptr", "QWidget::clearFocus(void)"),
	...
	mu_demangle_test("_ZN7QWidget14activateWindowEv_ptr", "QWidget::activateWindow(void)"),
	...
	mu_demangle_test("_ZN7QWidget14updateGeometryEv_ptr", "QWidget::updateGeometry(void)"),
	...
	mu_demangle_test("_ZN7QWidget4hideEv_ptr", "QWidget::hide(void)"),
	mu_demangle_test("_ZN7QWidget4moveERK6QPoint_ptr", "QWidget::move(QPoint const&)"),
	mu_demangle_test("_ZN7QWidget4showEv_ptr", "QWidget::show(void)"),
	mu_demangle_test("_ZN7QWidget5closeEv_ptr", "QWidget::close(void)"),
	mu_demangle_test("_ZN7QWidget5eventEP6QEvent_ptr", "QWidget::event(QEvent*)"),
	mu_demangle_test("_ZN7QWidget5raiseEv_ptr", "QWidget::raise(void)"),
	mu_demangle_test("_ZN7QWidget6resizeERK5QSize_ptr", "QWidget::resize(QSize const&)"),
	mu_demangle_test("_ZN7QWidget6updateEv_ptr", "QWidget::update(void)"),
	...
	mu_demangle_test("_ZN7QWidgetD2Ev_ptr", "QWidget::~QWidget(void)"),
	...
	mu_demangle_test("_ZN8QPainter3endEv_ptr", "QPainter::end(void)"),
	mu_demangle_test("_ZN8QPainter4saveEv_ptr", "QPainter::save(void)"),
	...
	mu_demangle_test("_ZN8QPainter7restoreEv_ptr", "QPainter::restore(void)"),
	...
	mu_demangle_test("_ZN8QPainterC1Ev_ptr", "QPainter::QPainter(void)"),
	mu_demangle_test("_ZN8QPainterD1Ev_ptr", "QPainter::~QPainter(void)"),
	...
	mu_demangle_test("_ZN8QPaletteD1Ev_ptr", "QPalette::~QPalette(void)"),
	mu_demangle_test("_ZN8QPictureC1Ei_ptr", "QPicture::QPicture(int)"),
	mu_demangle_test("_ZN8QPictureD1Ev_ptr", "QPicture::~QPicture(void)"),
	...
	mu_demangle_test("_ZN8QSysInfo17prettyProductNameEv_ptr", "QSysInfo::prettyProductName(void)"),
	...
	mu_demangle_test("_ZN8QToolBarD2Ev_ptr", "QToolBar::~QToolBar(void)"),
	...
	mu_demangle_test("_ZN8QVariantD1Ev_ptr", "QVariant::~QVariant(void)"),
	...
	mu_demangle_test("_ZN8UIAction19readKeyBindingsFileEv_ptr", "UIAction::readKeyBindingsFile(void)"),
	...
	mu_demangle_test("_ZN8UIAction20setActionDisplayNameERK7QStringRKSt8functionIFS0_vEE_ptr", "UIAction::setActionDisplayName(QString const&, std::function<QString (void)> const&)"),
	mu_demangle_test("_ZN8UIAction20writeKeyBindingsFileEv_ptr", "UIAction::writeKeyBindingsFile(void)"),
	mu_demangle_test("_ZN8UIAction23getAllRegisteredActionsEv_ptr", "UIAction::getAllRegisteredActions(void)"),
	mu_demangle_test("_ZN8UIAction24registerTransformActionsEv_ptr", "UIAction::registerTransformActions(void)"),
	mu_demangle_test("_ZN8UIAction24resetKeyBindingToDefaultERK7QString_ptr", "UIAction::resetKeyBindingToDefault(QString const&)"),
	mu_demangle_test("_ZN8UIAction28registerPluginCommandActionsEv_ptr", "UIAction::registerPluginCommandActions(void)"),
	mu_demangle_test("_ZN8UIActionC1ERKSt8functionIFvvEE_ptr", "UIAction::UIAction(std::function<void (void)> const&)"),
	mu_demangle_test("_ZN8UIActionC1ERKSt8functionIFvvEERKS0_IFbRK15UIActionContextEE_ptr", "UIAction::UIAction(std::function<void (void)> const&, std::function<bool (UIActionContext const&)> const&)"),
	mu_demangle_test("_ZN8UIActionC1ERKSt8functionIFvvEERKS0_IFbvEE_ptr", "UIAction::UIAction(std::function<void (void)> const&, std::function<bool (void)> const&)"),
	mu_demangle_test("_ZN8ViewType8getTypesEv_ptr", "ViewType::getTypes(void)"),
	mu_demangle_test("_ZN8WebPage211linkClickedERK4QUrl_4_0", "WebPage2::linkClicked(QUrl const&)"),
	mu_demangle_test("_ZN9LogStatus15clearIndicatorsEv_ptr", "LogStatus::clearIndicators(void)"),
	...
	mu_demangle_test("_ZN9QComboBox5clearEv_ptr", "QComboBox::clear(void)"),
	...
	mu_demangle_test("_ZN9QDateTime18currentDateTimeUtcEv_ptr", "QDateTime::currentDateTimeUtc(void)"),
	...
	mu_demangle_test("_ZN9QDateTimeC1Ev_ptr", "QDateTime::QDateTime(void)"),
	mu_demangle_test("_ZN9QDateTimeD1Ev_ptr", "QDateTime::~QDateTime(void)"),
	mu_demangle_test("_ZN9QFileInfoC1ERK7QString_ptr", "QFileInfo::QFileInfo(QString const&)"),
	mu_demangle_test("_ZN9QFileInfoD1Ev_ptr", "QFileInfo::~QFileInfo(void)"),
	...
	mu_demangle_test("_ZN9QIODevice7readAllEv_ptr", "QIODevice::readAll(void)"),
	mu_demangle_test("_ZN9QIODeviceC2Ev_ptr", "QIODevice::QIODevice(void)"),
	mu_demangle_test("_ZN9QIODeviceD2Ev_ptr", "QIODevice::~QIODevice(void)"),
	...
	mu_demangle_test("_ZN9QLineEdit3cutEv_ptr", "QLineEdit::cut(void)"),
	mu_demangle_test("_ZN9QLineEdit4redoEv_ptr", "QLineEdit::redo(void)"),
	mu_demangle_test("_ZN9QLineEdit4undoEv_ptr", "QLineEdit::undo(void)"),
	mu_demangle_test("_ZN9QLineEdit5pasteEv_ptr", "QLineEdit::paste(void)"),
	mu_demangle_test("_ZN9QLineEdit7setTextERK7QString_ptr", "QLineEdit::setText(QString const&)"),
	mu_demangle_test("_ZN9QLineEdit9selectAllEv_ptr", "QLineEdit::selectAll(void)"),
	...
	mu_demangle_test("_ZN9QLineEditD2Ev_ptr", "QLineEdit::~QLineEdit(void)"),
	...
	mu_demangle_test("_ZN9QListData6appendEv_ptr", "QListData::append(void)"),
	...
	mu_demangle_test("_ZN9QListViewD2Ev_ptr", "QListView::~QListView(void)"),
	...
	mu_demangle_test("_ZN9QMimeDataC1Ev_ptr", "QMimeData::QMimeData(void)"),
	...
	mu_demangle_test("_ZN9QResourceD1Ev_ptr", "QResource::~QResource(void)"),
	mu_demangle_test("_ZN9QRunnableD2Ev_ptr", "QRunnable::~QRunnable(void)"),
	...
	mu_demangle_test("_ZN9QSettingsD1Ev_ptr", "QSettings::~QSettings(void)"),
	...
	mu_demangle_test("_ZN9QTextEdit3cutEv_ptr", "QTextEdit::cut(void)"),
	mu_demangle_test("_ZN9QTextEdit4copyEv_ptr", "QTextEdit::copy(void)"),
	mu_demangle_test("_ZN9QTextEdit4redoEv_ptr", "QTextEdit::redo(void)"),
	mu_demangle_test("_ZN9QTextEdit4undoEv_ptr", "QTextEdit::undo(void)"),
	mu_demangle_test("_ZN9QTextEdit5pasteEv_ptr", "QTextEdit::paste(void)"),
	...
	mu_demangle_test("_ZN9QTextEdit9selectAllEv_ptr", "QTextEdit::selectAll(void)"),
	...
	mu_demangle_test("_ZN9QTreeView9expandAllEv_ptr", "QTreeView::expandAll(void)"),
	...
	mu_demangle_test("_ZN9QTreeViewD2Ev_ptr", "QTreeView::~QTreeView(void)"),
	mu_demangle_test("_ZN9QUrlQueryC1ERK7QString_ptr", "QUrlQuery::QUrlQuery(QString const&)"),
	mu_demangle_test("_ZN9QUrlQueryD1Ev_ptr", "QUrlQuery::~QUrlQuery(void)"),
	...
	mu_demangle_test("_ZN9UIContext19NotifyOnContextOpenEv_ptr", "UIContext::NotifyOnContextOpen(void)"),
	mu_demangle_test("_ZN9UIContext20NotifyOnContextCloseEv_ptr", "UIContext::NotifyOnContextClose(void)"),
	...
	mu_demangle_test("_ZN9UIContextC2Ev_ptr", "UIContext::UIContext(void)"),
	mu_demangle_test("_ZN9UIContextD2Ev_ptr", "UIContext::~UIContext(void)"),
	mu_demangle_test("_ZN9ViewFrame10getTabNameEv_ptr", "ViewFrame::getTabName(void)"),
	mu_demangle_test("_ZN9ViewFrame11setViewTypeERK7QString_ptr", "ViewFrame::setViewType(QString const&)"),
	mu_demangle_test("_ZN9ViewFrame11updateFontsEv_ptr", "ViewFrame::updateFonts(void)"),
	mu_demangle_test("_ZN9ViewFrame11updateThemeEv_ptr", "ViewFrame::updateTheme(void)"),
	mu_demangle_test("_ZN9ViewFrame12closeRequestEv_ptr", "ViewFrame::closeRequest(void)"),
	mu_demangle_test("_ZN9ViewFrame14getCurrentViewEv_ptr", "ViewFrame::getCurrentView(void)"),
	mu_demangle_test("_ZN9ViewFrame15getViewLocationEv_ptr", "ViewFrame::getViewLocation(void)"),
	mu_demangle_test("_ZN9ViewFrame15setViewLocationERK12ViewLocation_ptr", "ViewFrame::setViewLocation(ViewLocation const&)"),
	mu_demangle_test("_ZN9ViewFrame16getShortFileNameEv_ptr", "ViewFrame::getShortFileName(void)"),
	mu_demangle_test("_ZN9ViewFrame18getCurrentDataTypeEv_ptr", "ViewFrame::getCurrentDataType(void)"),
	...
	mu_demangle_test("_ZN9ViewFrame21updateCrossReferencesEv_ptr", "ViewFrame::updateCrossReferences(void)"),
	mu_demangle_test("_ZN9ViewFrame25getFileContentsLockStatusEv_ptr", "ViewFrame::getFileContentsLockStatus(void)"),
	mu_demangle_test("_ZN9ViewFrame4backEv_ptr", "ViewFrame::back(void)"),
	mu_demangle_test("_ZN9ViewFrame5focusEv_ptr", "ViewFrame::focus(void)"),
	mu_demangle_test("_ZN9ViewFrame7closingEv_ptr", "ViewFrame::closing(void)"),
	mu_demangle_test("_ZN9ViewFrame7forwardEv_ptr", "ViewFrame::forward(void)"),
	...
	mu_demangle_test("_ZNK10QTableView14verticalHeaderEv_ptr", "QTableView::verticalHeader(void) const"),
	mu_demangle_test("_ZNK10QTableView16horizontalHeaderEv_ptr", "QTableView::horizontalHeader(void) const"),
	mu_demangle_test("_ZNK10QTableView9gridStyleEv_ptr", "QTableView::gridStyle(void) const"),
	mu_demangle_test("_ZNK10QTabWidget12currentIndexEv_ptr", "QTabWidget::currentIndex(void) const"),
	mu_demangle_test("_ZNK10QTabWidget13currentWidgetEv_ptr", "QTabWidget::currentWidget(void) const"),
	mu_demangle_test("_ZNK10QTabWidget5countEv_ptr", "QTabWidget::count(void) const"),
	mu_demangle_test("_ZNK10QTabWidget6tabBarEv_ptr", "QTabWidget::tabBar(void) const"),
	...
	mu_demangle_test("_ZNK11BinaryNinja13FlowGraphNode12GetHighlightEv_5_0", "BinaryNinja::FlowGraphNode::GetHighlight(void) const"),
	mu_demangle_test("_ZNK11BinaryNinja13FlowGraphNode12GetHighlightEv_5_1", "BinaryNinja::FlowGraphNode::GetHighlight(void) const"),
	mu_demangle_test("_ZNK11BinaryNinja13FlowGraphNode12GetHighlightEv_5_2", "BinaryNinja::FlowGraphNode::GetHighlight(void) const"),
	mu_demangle_test("_ZNK11BinaryNinja13FlowGraphNode12GetHighlightEv_5_3", "BinaryNinja::FlowGraphNode::GetHighlight(void) const"),
	mu_demangle_test("_ZNK11QJsonObject8containsERK7QString_ptr", "QJsonObject::contains(QString const&) const"),
	mu_demangle_test("_ZNK11QMainWindow20isDockNestingEnabledEv_ptr", "QMainWindow::isDockNestingEnabled(void) const"),
	mu_demangle_test("_ZNK11QMainWindow6cornerEN2Qt6CornerE_ptr", "QMainWindow::corner(Qt::Corner) const"),
	mu_demangle_test("_ZNK11QMainWindow7menuBarEv_ptr", "QMainWindow::menuBar(void) const"),
	mu_demangle_test("_ZNK11QMainWindow9saveStateEi_ptr", "QMainWindow::saveState(int) const"),
	mu_demangle_test("_ZNK11QMainWindow9statusBarEv_ptr", "QMainWindow::statusBar(void) const"),
	...
	mu_demangle_test("_ZNK11QMetaObject9classNameEv_ptr", "QMetaObject::className(void) const"),
	mu_demangle_test("_ZNK11QObjectData17dynamicMetaObjectEv_ptr", "QObjectData::dynamicMetaObject(void) const"),
	mu_demangle_test("_ZNK12QDirIterator7hasNextEv_ptr", "QDirIterator::hasNext(void) const"),
	mu_demangle_test("_ZNK12QDirIterator8fileInfoEv_ptr", "QDirIterator::fileInfo(void) const"),
	mu_demangle_test("_ZNK12QDirIterator8fileNameEv_ptr", "QDirIterator::fileName(void) const"),
	...
	mu_demangle_test("_ZNK12QFontMetrics6ascentEv_ptr", "QFontMetrics::ascent(void) const"),
	mu_demangle_test("_ZNK12QFontMetrics6heightEv_ptr", "QFontMetrics::height(void) const"),
	mu_demangle_test("_ZNK12QInputDialog9textValueEv_ptr", "QInputDialog::textValue(void) const"),
	mu_demangle_test("_ZNK12QKeySequence7isEmptyEv_ptr", "QKeySequence::isEmpty(void) const"),
	...
	mu_demangle_test("_ZNK13QFileAccessor7IsValidEv_ptr", "QFileAccessor::IsValid(void) const"),
	mu_demangle_test("_ZNK13QFontMetricsF6heightEv_ptr", "QFontMetricsF::height(void) const"),
	...
	mu_demangle_test("_ZNK13QJsonDocument6objectEv_ptr", "QJsonDocument::object(void) const"),
	mu_demangle_test("_ZNK13QJsonDocumentixERK7QString_ptr", "QJsonDocument::operator[](QString const&) const"),
	mu_demangle_test("_ZNK13QNetworkReply10isFinishedEv_ptr", "QNetworkReply::isFinished(void) const"),
	mu_demangle_test("_ZNK13QNetworkReply12hasRawHeaderERK10QByteArray_ptr", "QNetworkReply::hasRawHeader(QByteArray const&) const"),
	mu_demangle_test("_ZNK13QNetworkReply14rawHeaderPairsEv_ptr", "QNetworkReply::rawHeaderPairs(void) const"),
	mu_demangle_test("_ZNK13QNetworkReply5errorEv_ptr", "QNetworkReply::error(void) const"),
	...
	mu_demangle_test("_ZNK14QItemSelection7indexesEv_ptr", "QItemSelection::indexes(void) const"),
	mu_demangle_test("_ZNK14QWebEnginePage7profileEv_ptr", "QWebEnginePage::profile(void) const"),
	mu_demangle_test("_ZNK14QWebEngineView4pageEv_ptr", "QWebEngineView::page(void) const"),
	mu_demangle_test("_ZNK14QWebEngineView8settingsEv_ptr", "QWebEngineView::settings(void) const"),
	mu_demangle_test("_ZNK15QAbstractButton9isCheckedEv_ptr", "QAbstractButton::isChecked(void) const"),
	mu_demangle_test("_ZNK15QProgressDialog11wasCanceledEv_ptr", "QProgressDialog::wasCanceled(void) const"),
	mu_demangle_test("_ZNK15QProgressDialog7maximumEv_ptr", "QProgressDialog::maximum(void) const"),
	mu_demangle_test("_ZNK15QProgressDialog7minimumEv_ptr", "QProgressDialog::minimum(void) const"),
	mu_demangle_test("_ZNK16QKeySequenceEdit11keySequenceEv_ptr", "QKeySequenceEdit::keySequence(void) const"),
	mu_demangle_test("_ZNK17QAbstractItemView12itemDelegateEv_ptr", "QAbstractItemView::itemDelegate(void) const"),
	mu_demangle_test("_ZNK17QAbstractItemView14selectionModelEv_ptr", "QAbstractItemView::selectionModel(void) const"),
	mu_demangle_test("_ZNK17QAbstractItemView5modelEv_ptr", "QAbstractItemView::model(void) const"),
	mu_demangle_test("_ZNK18QAbstractAnimation9directionEv_ptr", "QAbstractAnimation::direction(void) const"),
	mu_demangle_test("_ZNK18QAbstractItemModel5flagsERK11QModelIndex_ptr", "QAbstractItemModel::flags(QModelIndex const&) const"),
	mu_demangle_test("_ZNK18QCommandLineParser19positionalArgumentsEv_ptr", "QCommandLineParser::positionalArguments(void) const"),
	...
	mu_demangle_test("_ZNK18QRegularExpression7isValidEv_ptr", "QRegularExpression::isValid(void) const"),
	mu_demangle_test("_ZNK18QRegularExpression7patternEv_ptr", "QRegularExpression::pattern(void) const"),
	mu_demangle_test("_ZNK19QAbstractProxyModel11sourceModelEv_ptr", "QAbstractProxyModel::sourceModel(void) const"),
	mu_demangle_test("_ZNK19QAbstractScrollArea17verticalScrollBarEv_ptr", "QAbstractScrollArea::verticalScrollBar(void) const"),
	mu_demangle_test("_ZNK19QAbstractScrollArea19horizontalScrollBarEv_ptr", "QAbstractScrollArea::horizontalScrollBar(void) const"),
	mu_demangle_test("_ZNK19QItemSelectionModel9selectionEv_ptr", "QItemSelectionModel::selection(void) const"),
	...
	mu_demangle_test("_ZNK21QSortFilterProxyModel12filterRegExpEv_ptr", "QSortFilterProxyModel::filterRegExp(void) const"),
	mu_demangle_test("_ZNK21QSortFilterProxyModel23filterRegularExpressionEv_ptr", "QSortFilterProxyModel::filterRegularExpression(void) const"),
	...
	mu_demangle_test("_ZNK23QRegularExpressionMatch13capturedTextsEv_ptr", "QRegularExpressionMatch::capturedTexts(void) const"),
	mu_demangle_test("_ZNK23QRegularExpressionMatch8hasMatchEv_ptr", "QRegularExpressionMatch::hasMatch(void) const"),
	mu_demangle_test("_ZNK4QDir16absoluteFilePathERK7QString_ptr", "QDir::absoluteFilePath(QString const&) const"),
	mu_demangle_test("_ZNK4QDir6existsEv_ptr", "QDir::exists(void) const"),
	mu_demangle_test("_ZNK4QDir6mkpathERK7QString_ptr", "QDir::mkpath(QString const&) const"),
	mu_demangle_test("_ZNK4QUrl11isLocalFileEv_ptr", "QUrl::isLocalFile(void) const"),
	mu_demangle_test("_ZNK4QUrl11toLocalFileEv_ptr", "QUrl::toLocalFile(void) const"),
	...
	mu_demangle_test("_ZNK4QUrl6schemeEv_ptr", "QUrl::scheme(void) const"),
	mu_demangle_test("_ZNK4QUrl7isValidEv_ptr", "QUrl::isValid(void) const"),
	...
	mu_demangle_test("_ZNK5QFile4sizeEv_ptr", "QFile::size(void) const"),
	mu_demangle_test("_ZNK5QFile6existsEv_ptr", "QFile::exists(void) const"),
	mu_demangle_test("_ZNK5QFont6familyEv_ptr", "QFont::family(void) const"),
	mu_demangle_test("_ZNK5QFont9pointSizeEv_ptr", "QFont::pointSize(void) const"),
	mu_demangle_test("_ZNK5QFont9styleNameEv_ptr", "QFont::styleName(void) const"),
	...
	mu_demangle_test("_ZNK6QColor4nameEv_ptr", "QColor::name(void) const"),
	mu_demangle_test("_ZNK6QColor6darkerEi_ptr", "QColor::darker(int) const"),
	mu_demangle_test("_ZNK6QColor9lightnessEv_ptr", "QColor::lightness(void) const"),
	mu_demangle_test("_ZNK6QLabel20textInteractionFlagsEv_ptr", "QLabel::textInteractionFlags(void) const"),
	mu_demangle_test("_ZNK6QLabel4textEv_ptr", "QLabel::text(void) const"),
	mu_demangle_test("_ZNK7QAction4dataEv_ptr", "QAction::data(void) const"),
	...
	mu_demangle_test("_ZNK7QObject6senderEv_ptr", "QObject::sender(void) const"),
	...
	mu_demangle_test("_ZNK7QRegExp7isEmptyEv_ptr", "QRegExp::isEmpty(void) const"),
	mu_demangle_test("_ZNK7QScreen4sizeEv_ptr", "QScreen::size(void) const"),
	mu_demangle_test("_ZNK7QScreen8geometryEv_ptr", "QScreen::geometry(void) const"),
	...
	mu_demangle_test("_ZNK7QString13toHtmlEscapedEv_ptr", "QString::toHtmlEscaped(void) const"), );
