...
mu_demangle_tests(gpl,
	...
	mu_demangle_test("_Z1fIDnLDn0EEvv", "void f<decltype(nullptr), (decltype(nullptr))0>(void)"),
	// clang
	...
	mu_demangle_test("_ZN4llvm24PassRegistrationListenerC2Ev", "llvm::PassRegistrationListener::PassRegistrationListener(void)"),
	mu_demangle_test("_ZN4llvm24PassRegistrationListener15enumeratePassesEv", "llvm::PassRegistrationListener::enumeratePasses(void)"),
	mu_demangle_test("_ZN4llvm12PassRegistry15getPassRegistryEv", "llvm::PassRegistry::getPassRegistry(void)"),
	mu_demangle_test("_ZNK4llvm12PassRegistry7getImplEv", "llvm::PassRegistry::getImpl(void) const"),
	...
	mu_demangle_test("_ZN4llvm3sys11MemoryFenceEv", "llvm::sys::MemoryFence(void)"),
	mu_demangle_test("_ZN4llvm2cl6Option11addArgumentEv", "llvm::cl::Option::addArgument(void)"),
	mu_demangle_test("_ZN4llvm2cl18MarkOptionsChangedEv", "llvm::cl::MarkOptionsChanged(void)"),
	mu_demangle_test("_ZNK4llvm17ManagedStaticBase21RegisterManagedStaticEPFPvvEPFvS1_E", "llvm::ManagedStaticBase::RegisterManagedStatic(void* (*)(void), void (*)(void*)) const"),
	mu_demangle_test("_ZN4llvm3sys9MutexImplC2Eb", "llvm::sys::MutexImpl::MutexImpl(bool)"),
	mu_demangle_test("_ZN4llvm3sys9MutexImpl7acquireEv", "llvm::sys::MutexImpl::acquire(void)"),
	mu_demangle_test("_ZN4llvm3sys9MutexImpl7releaseEv", "llvm::sys::MutexImpl::release(void)"),
	mu_demangle_test("_ZN4llvm15SmallVectorBase8grow_podEmm", "llvm::SmallVectorBase::grow_pod(unsigned long, unsigned long)"),
	mu_demangle_test("_ZN4llvm3sys15ThreadLocalImplC2Ev", "llvm::sys::ThreadLocalImpl::ThreadLocalImpl(void)"),
	mu_demangle_test("_ZN4llvm21llvm_is_multithreadedEv", "llvm::llvm_is_multithreaded(void)"),
	mu_demangle_test("_ZN4llvm24llvm_acquire_global_lockEv", "llvm::llvm_acquire_global_lock(void)"),
	mu_demangle_test("_ZN4llvm24llvm_release_global_lockEv", "llvm::llvm_release_global_lock(void)"),
	mu_demangle_test("_ZN4llvm15system_categoryEv", "llvm::system_category(void)"),
	...
	mu_demangle_test("_ZNK4llvm18IntrusiveRefCntPtrIN5clang10DiagnosticEE6getPtrEv", "llvm::IntrusiveRefCntPtr<clang::Diagnostic>::getPtr(void) const"),
	...
	mu_demangle_test("_ZN5clang16DiagnosticClient13EndSourceFileEv", "clang::DiagnosticClient::EndSourceFile(void)"),
	mu_demangle_test("_ZN5clang18CompilerInvocationD2Ev", "clang::CompilerInvocation::~CompilerInvocation(void)"),
	mu_demangle_test("_ZN5clang14CodeGenOptionsD2Ev", "clang::CodeGenOptions::~CodeGenOptions(void)"),
	mu_demangle_test("_ZN5clang23DependencyOutputOptionsD2Ev", "clang::DependencyOutputOptions::~DependencyOutputOptions(void)"),
	mu_demangle_test("_ZN5clang15FrontendOptionsD2Ev", "clang::FrontendOptions::~FrontendOptions(void)"),
	mu_demangle_test("_ZN5clang19HeaderSearchOptionsD2Ev", "clang::HeaderSearchOptions::~HeaderSearchOptions(void)"),
	mu_demangle_test("_ZN5clang19PreprocessorOptionsD2Ev", "clang::PreprocessorOptions::~PreprocessorOptions(void)"),
	...
	mu_demangle_test("_ZN5clang13TargetOptionsD2Ev", "clang::TargetOptions::~TargetOptions(void)"),
	mu_demangle_test("_ZN5clang18CompilerInvocationC2Ev", "clang::CompilerInvocation::CompilerInvocation(void)"),
	mu_demangle_test("_Z10cc1as_mainPPKcS1_S0_Pv", "cc1as_main(char const**, char const**, char const*, void*)"),
	mu_demangle_test("_Z16LLVMErrorHandlerPvRKSs", "LLVMErrorHandler(void*, std::string const&)"),
	mu_demangle_test("_ZN4llvm23PrettyStackTraceProgramD1Ev", "llvm::PrettyStackTraceProgram::~PrettyStackTraceProgram(void)"),
	mu_demangle_test("_ZN4llvm23PrettyStackTraceProgramD0Ev", "llvm::PrettyStackTraceProgram::~PrettyStackTraceProgram(void)"),
	...
	mu_demangle_test("_ZN4llvm21formatted_raw_ostreamD1Ev", "llvm::formatted_raw_ostream::~formatted_raw_ostream(void)"),
	mu_demangle_test("_ZN4llvm21formatted_raw_ostreamD0Ev", "llvm::formatted_raw_ostream::~formatted_raw_ostream(void)"),
	...
	mu_demangle_test("_ZN4llvm11raw_ostream10resetColorEv", "llvm::raw_ostream::resetColor(void)"),
	mu_demangle_test("_ZNK4llvm11raw_ostream12is_displayedEv", "llvm::raw_ostream::is_displayed(void) const"),
	mu_demangle_test("_ZNK4llvm21formatted_raw_ostream11current_posEv", "llvm::formatted_raw_ostream::current_pos(void) const"),
	mu_demangle_test("_ZN4llvm21formatted_raw_ostream13releaseStreamEv", "llvm::formatted_raw_ostream::releaseStream(void)"),
	mu_demangle_test("_ZN4llvm10error_code21unspecified_bool_trueEv", "llvm::error_code::unspecified_bool_true(void)"),
	...
	mu_demangle_test("_ZN5clang14FrontendAction19EndSourceFileActionEv", "clang::FrontendAction::EndSourceFileAction(void)"),
	mu_demangle_test("_ZNK5clang26PreprocessorFrontendAction20usesPreprocessorOnlyEv", "clang::PreprocessorFrontendAction::usesPreprocessorOnly(void) const"),
	mu_demangle_test("_ZN5clang14FrontendAction27usesCompleteTranslationUnitEv", "clang::FrontendAction::usesCompleteTranslationUnit(void)"),
	mu_demangle_test("_ZNK5clang14FrontendAction13hasPCHSupportEv", "clang::FrontendAction::hasPCHSupport(void) const"),
	mu_demangle_test("_ZNK5clang14FrontendAction17hasASTFileSupportEv", "clang::FrontendAction::hasASTFileSupport(void) const"),
	mu_demangle_test("_ZNK5clang14FrontendAction12hasIRSupportEv", "clang::FrontendAction::hasIRSupport(void) const"),
	mu_demangle_test("_ZNK5clang14FrontendAction24hasCodeCompletionSupportEv", "clang::FrontendAction::hasCodeCompletionSupport(void) const"),
	mu_demangle_test("_ZN5clang26PreprocessorFrontendActionD1Ev", "clang::PreprocessorFrontendAction::~PreprocessorFrontendAction(void)"),
	mu_demangle_test("_ZN5clang26PreprocessorFrontendActionD0Ev", "clang::PreprocessorFrontendAction::~PreprocessorFrontendAction(void)"),
	mu_demangle_test("_ZNK5clang17ASTFrontendAction20usesPreprocessorOnlyEv", "clang::ASTFrontendAction::usesPreprocessorOnly(void) const"),
	mu_demangle_test("_ZN5clang17ASTFrontendActionD1Ev", "clang::ASTFrontendAction::~ASTFrontendAction(void)"),
	mu_demangle_test("_ZN5clang17ASTFrontendActionD0Ev", "clang::ASTFrontendAction::~ASTFrontendAction(void)"),
	mu_demangle_test("_ZNK5clang23PrintPreprocessedAction13hasPCHSupportEv", "clang::PrintPreprocessedAction::hasPCHSupport(void) const"),
	...
	mu_demangle_test("_ZNK5clang19PrintPreambleAction20usesPreprocessorOnlyEv", "clang::PrintPreambleAction::usesPreprocessorOnly(void) const"),
	mu_demangle_test("_ZN5clang16SyntaxOnlyActionD1Ev", "clang::SyntaxOnlyAction::~SyntaxOnlyAction(void)"),
	mu_demangle_test("_ZN5clang16SyntaxOnlyActionD0Ev", "clang::SyntaxOnlyAction::~SyntaxOnlyAction(void)"),
	mu_demangle_test("_ZNK5clang16SyntaxOnlyAction24hasCodeCompletionSupportEv", "clang::SyntaxOnlyAction::hasCodeCompletionSupport(void) const"),
	mu_demangle_test("_ZNK5clang14InitOnlyAction20usesPreprocessorOnlyEv", "clang::InitOnlyAction::usesPreprocessorOnly(void) const"),
	mu_demangle_test("_ZN5clang17GeneratePCHAction27usesCompleteTranslationUnitEv", "clang::GeneratePCHAction::usesCompleteTranslationUnit(void)"),
	mu_demangle_test("_ZNK5clang17GeneratePCHAction17hasASTFileSupportEv", "clang::GeneratePCHAction::hasASTFileSupport(void) const"),
	...
	mu_demangle_test("_ZN5clang15CreateASTDumperEv", "clang::CreateASTDumper(void)"),
	mu_demangle_test("_ZN5clang15CreateASTViewerEv", "clang::CreateASTViewer(void)"),
	mu_demangle_test("_ZN5clang24CreateDeclContextPrinterEv", "clang::CreateDeclContextPrinter(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_110ASTDumpXMLD1Ev", "(anonymous namespace)::ASTDumpXML::~ASTDumpXML(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_110ASTDumpXMLD0Ev", "(anonymous namespace)::ASTDumpXML::~ASTDumpXML(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_117InheritanceViewerD1Ev", "(anonymous namespace)::InheritanceViewer::~InheritanceViewer(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_117InheritanceViewerD0Ev", "(anonymous namespace)::InheritanceViewer::~InheritanceViewer(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_118DeclContextPrinterD1Ev", "(anonymous namespace)::DeclContextPrinter::~DeclContextPrinter(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_118DeclContextPrinterD0Ev", "(anonymous namespace)::DeclContextPrinter::~DeclContextPrinter(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_19ASTViewerD1Ev", "(anonymous namespace)::ASTViewer::~ASTViewer(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_19ASTViewerD0Ev", "(anonymous namespace)::ASTViewer::~ASTViewer(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_113ASTPrinterXMLD1Ev", "(anonymous namespace)::ASTPrinterXML::~ASTPrinterXML(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_113ASTPrinterXMLD0Ev", "(anonymous namespace)::ASTPrinterXML::~ASTPrinterXML(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_110ASTPrinterD1Ev", "(anonymous namespace)::ASTPrinter::~ASTPrinter(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_110ASTPrinterD0Ev", "(anonymous namespace)::ASTPrinter::~ASTPrinter(void)"),
	...
	mu_demangle_test("_ZN5clang14ASTMergeAction13ExecuteActionEv", "clang::ASTMergeAction::ExecuteAction(void)"),
	mu_demangle_test("_ZN5clang14ASTMergeAction19EndSourceFileActionEv", "clang::ASTMergeAction::EndSourceFileAction(void)"),
	...
	mu_demangle_test("_ZN5clang14ASTMergeActionD0Ev", "clang::ASTMergeAction::~ASTMergeAction(void)"),
	mu_demangle_test("_ZN5clang14ASTMergeActionD1Ev", "clang::ASTMergeAction::~ASTMergeAction(void)"),
	mu_demangle_test("_ZN5clang14ASTMergeActionD2Ev", "clang::ASTMergeAction::~ASTMergeAction(void)"),
	mu_demangle_test("_ZNK5clang14ASTMergeAction20usesPreprocessorOnlyEv", "clang::ASTMergeAction::usesPreprocessorOnly(void) const"),
	mu_demangle_test("_ZN5clang14ASTMergeAction27usesCompleteTranslationUnitEv", "clang::ASTMergeAction::usesCompleteTranslationUnit(void)"),
	mu_demangle_test("_ZNK5clang14ASTMergeAction13hasPCHSupportEv", "clang::ASTMergeAction::hasPCHSupport(void) const"),
	mu_demangle_test("_ZNK5clang14ASTMergeAction17hasASTFileSupportEv", "clang::ASTMergeAction::hasASTFileSupport(void) const"),
	mu_demangle_test("_ZNK5clang14ASTMergeAction24hasCodeCompletionSupportEv", "clang::ASTMergeAction::hasCodeCompletionSupport(void) const"),
	...
	mu_demangle_test("_ZN5clang7ASTUnitD0Ev", "clang::ASTUnit::~ASTUnit(void)"),
	mu_demangle_test("_ZN5clang7ASTUnitD1Ev", "clang::ASTUnit::~ASTUnit(void)"),
	mu_demangle_test("_ZN5clang7ASTUnitD2Ev", "clang::ASTUnit::~ASTUnit(void)"),
	mu_demangle_test("_ZN5clang7ASTUnitD4Ev", "clang::ASTUnit::~ASTUnit(void)"),
	mu_demangle_test("_ZN5clang7ASTUnitD5Ev", "clang::ASTUnit::~ASTUnit(void)"),
	mu_demangle_test("_ZN5clang7ASTUnit19CleanTemporaryFilesEv", "clang::ASTUnit::CleanTemporaryFiles(void)"),
	mu_demangle_test("_ZN5clang7ASTUnit28ClearCachedCompletionResultsEv", "clang::ASTUnit::ClearCachedCompletionResults(void)"),
	mu_demangle_test("_ZN5clang7ASTUnit26CacheCodeCompletionResultsEv", "clang::ASTUnit::CacheCodeCompletionResults(void)"),
	mu_demangle_test("_ZNK5clang7ASTUnit15getMainFileNameEv", "clang::ASTUnit::getMainFileName(void) const"),
	mu_demangle_test("_ZN12_GLOBAL__N_111SimpleTimerD1Ev", "(anonymous namespace)::SimpleTimer::~SimpleTimer(void)"),
	mu_demangle_test("_ZN5clang7ASTUnit25getOriginalSourceFileNameEv", "clang::ASTUnit::getOriginalSourceFileName(void)"),
	mu_demangle_test("_ZN5clang7ASTUnit14getASTFileNameEv", "clang::ASTUnit::getASTFileName(void)"),
	...
	mu_demangle_test("_ZN5clang7ASTUnit32RealizeTopLevelDeclsFromPreambleEv", "clang::ASTUnit::RealizeTopLevelDeclsFromPreamble(void)"),
	mu_demangle_test("_ZN5clang7ASTUnit39RealizePreprocessedEntitiesFromPreambleEv", "clang::ASTUnit::RealizePreprocessedEntitiesFromPreamble(void)"),
	mu_demangle_test("_ZN5clang7ASTUnit15pp_entity_beginEv", "clang::ASTUnit::pp_entity_begin(void)"),
	mu_demangle_test("_ZN5clang7ASTUnit13pp_entity_endEv", "clang::ASTUnit::pp_entity_end(void)"),
	mu_demangle_test("_ZNK5clang7ASTUnit14getMaxPCHLevelEv", "clang::ASTUnit::getMaxPCHLevel(void) const"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_129AugmentedCodeCompleteConsumerD1Ev", "(anonymous namespace)::AugmentedCodeCompleteConsumer::~AugmentedCodeCompleteConsumer(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_129AugmentedCodeCompleteConsumerD0Ev", "(anonymous namespace)::AugmentedCodeCompleteConsumer::~AugmentedCodeCompleteConsumer(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_129AugmentedCodeCompleteConsumer12getAllocatorEv", "(anonymous namespace)::AugmentedCodeCompleteConsumer::getAllocator(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_122StoredDiagnosticClientD1Ev", "(anonymous namespace)::StoredDiagnosticClient::~StoredDiagnosticClient(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_122StoredDiagnosticClientD0Ev", "(anonymous namespace)::StoredDiagnosticClient::~StoredDiagnosticClient(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_124PrecompilePreambleActionD1Ev", "(anonymous namespace)::PrecompilePreambleAction::~PrecompilePreambleAction(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_124PrecompilePreambleActionD0Ev", "(anonymous namespace)::PrecompilePreambleAction::~PrecompilePreambleAction(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_124PrecompilePreambleAction27usesCompleteTranslationUnitEv", "(anonymous namespace)::PrecompilePreambleAction::usesCompleteTranslationUnit(void)"),
	mu_demangle_test("_ZNK12_GLOBAL__N_124PrecompilePreambleAction17hasASTFileSupportEv", "(anonymous namespace)::PrecompilePreambleAction::hasASTFileSupport(void) const"),
	mu_demangle_test("_ZNK12_GLOBAL__N_124PrecompilePreambleAction24hasCodeCompletionSupportEv", "(anonymous namespace)::PrecompilePreambleAction::hasCodeCompletionSupport(void) const"),
	mu_demangle_test("_ZN12_GLOBAL__N_126PrecompilePreambleConsumerD1Ev", "(anonymous namespace)::PrecompilePreambleConsumer::~PrecompilePreambleConsumer(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_126PrecompilePreambleConsumerD0Ev", "(anonymous namespace)::PrecompilePreambleConsumer::~PrecompilePreambleConsumer(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_126PrecompilePreambleConsumer27GetASTSerializationListenerEv", "(anonymous namespace)::PrecompilePreambleConsumer::GetASTSerializationListener(void)"),
	...
	mu_demangle_test("_ZThn1912_N12_GLOBAL__N_126PrecompilePreambleConsumerD1Ev", "non-virtual thunk to (anonymous namespace)::PrecompilePreambleConsumer::~PrecompilePreambleConsumer(void)"),
	mu_demangle_test("_ZThn1912_N12_GLOBAL__N_126PrecompilePreambleConsumerD0Ev", "non-virtual thunk to (anonymous namespace)::PrecompilePreambleConsumer::~PrecompilePreambleConsumer(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_125TopLevelDeclTrackerActionD1Ev", "(anonymous namespace)::TopLevelDeclTrackerAction::~TopLevelDeclTrackerAction(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_125TopLevelDeclTrackerActionD0Ev", "(anonymous namespace)::TopLevelDeclTrackerAction::~TopLevelDeclTrackerAction(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_125TopLevelDeclTrackerAction27usesCompleteTranslationUnitEv", "(anonymous namespace)::TopLevelDeclTrackerAction::usesCompleteTranslationUnit(void)"),
	mu_demangle_test("_ZNK12_GLOBAL__N_125TopLevelDeclTrackerAction24hasCodeCompletionSupportEv", "(anonymous namespace)::TopLevelDeclTrackerAction::hasCodeCompletionSupport(void) const"),
	mu_demangle_test("_ZN12_GLOBAL__N_127TopLevelDeclTrackerConsumerD1Ev", "(anonymous namespace)::TopLevelDeclTrackerConsumer::~TopLevelDeclTrackerConsumer(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_127TopLevelDeclTrackerConsumerD0Ev", "(anonymous namespace)::TopLevelDeclTrackerConsumer::~TopLevelDeclTrackerConsumer(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_116ASTInfoCollectorD1Ev", "(anonymous namespace)::ASTInfoCollector::~ASTInfoCollector(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_116ASTInfoCollectorD0Ev", "(anonymous namespace)::ASTInfoCollector::~ASTInfoCollector(void)"),
	...
	mu_demangle_test("_ZN5clang9ASTWriterD1Ev", "clang::ASTWriter::~ASTWriter(void)"),
	...
	mu_demangle_test("_ZN4llvm15BitstreamWriterD2Ev", "llvm::BitstreamWriter::~BitstreamWriter(void)"),
	mu_demangle_test("_ZThn8_N5clang9ASTWriterD1Ev", "non-virtual thunk to clang::ASTWriter::~ASTWriter(void)"),
	mu_demangle_test("_ZN5clang9ASTWriterD2Ev", "clang::ASTWriter::~ASTWriter(void)"),
	mu_demangle_test("_ZN5clang9ASTWriterD0Ev", "clang::ASTWriter::~ASTWriter(void)"),
	mu_demangle_test("_ZThn8_N5clang9ASTWriterD0Ev", "non-virtual thunk to clang::ASTWriter::~ASTWriter(void)"),
	...
	mu_demangle_test("_ZN5clang12PCHGeneratorD1Ev", "clang::PCHGenerator::~PCHGenerator(void)"),
	mu_demangle_test("_ZN5clang12PCHGeneratorD0Ev", "clang::PCHGenerator::~PCHGenerator(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_119BoostConASTConsumerD1Ev", "(anonymous namespace)::BoostConASTConsumer::~BoostConASTConsumer(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_119BoostConASTConsumerD0Ev", "(anonymous namespace)::BoostConASTConsumer::~BoostConASTConsumer(void)"),
	...
	mu_demangle_test("_ZN5clang14BoostConActionD1Ev", "clang::BoostConAction::~BoostConAction(void)"),
	mu_demangle_test("_ZN5clang14BoostConActionD0Ev", "clang::BoostConAction::~BoostConAction(void)"),
	...
	mu_demangle_test("_ZN12_GLOBAL__N_112StatListenerD1Ev", "(anonymous namespace)::StatListener::~StatListener(void)"),
	mu_demangle_test("_ZN12_GLOBAL__N_112StatListenerD0Ev", "(anonymous namespace)::StatListener::~StatListener(void)"),
	...
	mu_demangle_test("_ZN5clang16CompilerInstanceC1Ev", "clang::CompilerInstance::CompilerInstance(void)"),
	mu_demangle_test("_ZN5clang16CompilerInstanceC2Ev", "clang::CompilerInstance::CompilerInstance(void)"),
	mu_demangle_test("_ZN5clang16CompilerInstanceD1Ev", "clang::CompilerInstance::~CompilerInstance(void)"),
	mu_demangle_test("_ZN5clang16CompilerInstanceD2Ev", "clang::CompilerInstance::~CompilerInstance(void)"),
	...
	mu_demangle_test("_ZN5clang16CompilerInstance17createFileManagerEv", "clang::CompilerInstance::createFileManager(void)"),
	...
	mu_demangle_test("_ZN5clang16CompilerInstance18createPreprocessorEv", "clang::CompilerInstance::createPreprocessor(void)"),
	...
	mu_demangle_test("_ZN5clang16CompilerInstance16createASTContextEv", "clang::CompilerInstance::createASTContext(void)"),
	...
	mu_demangle_test("_ZN5clang16CompilerInstance28createCodeCompletionConsumerEv", "clang::CompilerInstance::createCodeCompletionConsumer(void)"),
	...
	mu_demangle_test("_ZN5clang16CompilerInstance19createFrontendTimerEv", "clang::CompilerInstance::createFrontendTimer(void)"),
